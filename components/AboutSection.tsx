...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="w-full max-w-[420px] px-8 py-12 text-left bg-[#050505]/90 backdrop-blur-md border border-white/5 rounded-[24px] mb-20 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-6 text-[15px] leading-[1.8] text-white/90 font-normal">
          ...
          <div className="pt-4 flex flex-row flex-wrap gap-x-6 gap-y-3">
            ...
            <a href="https://youtube.com/@ninjaxhustlerr" target="_blank" rel="noopener noreferrer" className="text-[13px] text-white/60 hover:text-white transition-colors flex items-center gap-2">
              <span className="w-1.5 h-1.5 rounded-full bg-white/20"></span>
              YouTube
            </a>
          </div>
